...
export const ACADEMY_INTENT_ALIASES: Record<string, string[]> = {
  ...
  fundamental: ['catalyst', 'calendar', 'earnings', 'news', 'revenue', 'margins', 'cash flow', 'valuation'],
  'fundamental analysis': ['catalyst', 'calendar', 'earnings', 'revenue', 'margins', 'cash flow', 'balance sheet'],
  'cash flow': ['earnings', 'cash conversion', 'free cash flow', 'statements'],
  margins: ['earnings', 'profitability', 'operating margin', 'statements'],
  profitability: ['earnings', 'margins', 'cash flow'],
  'balance sheet': ['leverage', 'debt', 'cash', 'obligations'],
  valuation: ['p/e', 'multiple', 'quality', 'moat'],
  moat: ['competitive advantage', 'quality', 'valuation'],
...
const EXTRA_KEYWORDS: Record<string, string[]> = {
  ...
  'fund-basics': ['fundamental', 'catalyst', 'earnings', 'valuation', 'quality', 'margins', 'revenue'],
  'fund-calendar': ['calendar', 'event risk', 'news', 'uncertainty'],
  'fund-statements': ['revenue', 'earnings', 'margins', 'cash flow', 'balance sheet', 'profitability'],
  'fund-valuation-quality': ['valuation', 'p/e', 'moat', 'advantage', 'quality', 'uncertainty'],
  'fund-economy': ['interest rates', 'macro', 'inflation'],

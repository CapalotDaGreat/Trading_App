...
export const DECISION_LESSONS: Lesson[] = [
  ...
  lesson({
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'TradeAcademy setups use statuses like forming vs confirmed for a reason. Forming means watchlist / light research. Confirmed means your checklist criteria are met — not that you must trade.\n\nKeep a “parking lot” for interesting but sub-threshold ideas. Revisit only if status improves; do not doom-scroll them.',
        callout: {
          type: 'warning',
  ...
  lesson({
    ...
    practiceLinks: [
      ...
      { label: 'Simulate tab', href: '/simulate' },
      {
        label: 'Decision Replay TV',
        href: '/decision/replay-tv',

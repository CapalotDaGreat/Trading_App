...
const WELCOME_MESSAGE: AiMessage = {
  ...
  role: 'assistant',
  content:
    "Hi! I'm your TradeVision AI assistant. Ask me about markets, technical analysis, risk management, or trading psychology. I provide analysis and education — not financial advice.",
  timestamp: Date.now(),
};

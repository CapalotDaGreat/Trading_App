...
const DEFS: AchievementDef[] = [
  ...
  {
    id: 'replay_tv_1',
    title: 'First Blind Room',
    detail: 'Complete your first Decision Replay TV episode under a blind tape.',
    category: 'replay',
    target: 1,
    celebrateCopy: 'First blind pause closed — process practice has begun.',
  ...
  {
    id: 'replay_tv_10',
    title: 'Ten Historical Events',
    detail: 'Complete ten Decision Replay TV episodes — process only.',
    category: 'replay',
    target: 10,
    celebrateCopy: 'Ten blind rooms deepen process memory — never direction scoreboards.',
    progressOf: (c) => c.replayTvEpisodes,
  },
  {
    id: 'replay_tv_calm_vol',
    title: 'Calm Under Volatility',
    detail: 'Three Replay TV sessions tagged for calm process under stress tapes.',
    category: 'patience',
    target: 3,
    celebrateCopy: 'Calm process under volatility is a skill — not a prediction trophy.',
    progressOf: (c) => c.replayTvCalmVol,
  },
  {
    id: 'replay_tv_evidence',
    title: 'Evidence-First Historian',
    detail: 'Three Replay TV sessions with strong evidence-quality process tags.',
    category: 'process',
    target: 3,
    celebrateCopy: 'Evidence before narrative — keep citing what the freeze actually showed.',
    progressOf: (c) => c.replayTvEvidence,
  },
  {
    id: 'replay_tv_invalidation',
    title: 'Excellent Invalidation',
    detail: 'Three Replay TV sessions with excellent invalidation clarity tags.',
    category: 'process',
    target: 3,
    celebrateCopy: 'Named invalidation under a blind tape is elite process hygiene.',
    progressOf: (c) => c.replayTvInvalidation,
  },
];

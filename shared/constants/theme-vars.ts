...
export const darkThemeVars = vars({
  ...
  '--color-premium': colors.premium.primary,
  '--color-premium-muted': colors.premium.muted,
...
export const lightThemeVars = vars({
  ...
  '--color-premium': colors.light.premium.primary,
  '--color-premium-muted': colors.light.premium.muted,

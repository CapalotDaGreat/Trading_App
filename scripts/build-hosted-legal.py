"""Build static HTML legal pages + deep-link well-known files for tradevision.ai hosting.
...
<head>
  ...
  <title>TradeVision AI Support</title>
  <style>
...
<body>
  <h1>TradeVision AI Support</h1>
  <p>Email: <a href="mailto:support@tradevision.ai">support@tradevision.ai</a></p>
  <p>TradeVision AI is an educational research and decision-coaching app. It is not a broker and does not provide buy/sell signals or execute trades.</p>
  <ul>
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>{html.escape(title)} · TradeVision AI</title>
  <style>
...
Upload everything in this folder to the **site root** of `https://tradevision.ai`
(or configure your CDN to map these paths).
